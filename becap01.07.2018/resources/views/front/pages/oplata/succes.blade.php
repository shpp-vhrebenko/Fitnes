    ...
    <div class="container oplata__container">
        <div class="row justify-content-center align-items-center ">
            <div class="col-md-6">
                ...
                <p class="oplata_description">На Вашу почту отправлено письмо с логином и паролем для входа в аккаунт. Пожалуйста проверте почту и авторизуйтесь в личном кабинете. На сайте <a class="oplata__link" href="{{route('index')}}">http://gizerskaya.com</a></p>
                <hr>
