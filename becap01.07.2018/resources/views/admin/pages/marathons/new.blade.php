                    ...
                    <div class="row">                      
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="whats_app_link" name="item[whats_app_link]" value="{{ isset($marathon) ? $marathon->whats_app_link : old('item.whats_app_link') }}">     
                                </div>
                            </div>                            
                            <div class="form-group row">
                                <label for="description_cours" class="col-sm-2 col-form-label">Содержание Марафона</label>
                                <div class="col-sm-10">                                    
                            ...
                            <div class="form-group row">
                                <label for="faq_cours" class="col-sm-2 col-form-label">FAQ Марафона</label>
                                <div class="col-sm-10">
