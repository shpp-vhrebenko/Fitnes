...
@section('content')
    <h1>{{ $title }} <a href="{{ route('show_courses') }}" class="fa fa-arrow-left btn-back" data-toggle="tooltip" data-placement="top" title="Вернутся назад"></a></h1>
                    ...
                    <div class="row">                      
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control summernote" name="item[food_regulations]" rows="3" id="food_regulations">{{ isset($cours) ? $cours->food_regulations : old('item.food_regulations') }}</textarea>
                                </div>
                            </div>
                            <div class="row">
